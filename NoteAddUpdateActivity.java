...
import com.nurshabrina.noteme.db.NoteHelper;
...
public class NoteAddUpdateActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nurshabrina.noteme.R.layout.activity_note_add_update);

        edtTitle = findViewById(com.nurshabrina.noteme.R.id.edt_title);
        edtDescription = findViewById(com.nurshabrina.noteme.R.id.edt_description);
        btnSubmit = findViewById(com.nurshabrina.noteme.R.id.btn_submit);
    ...
    public void onClick(View view) {
        if (view.getId() == com.nurshabrina.noteme.R.id.btn_submit) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (isEdit) {
            getMenuInflater().inflate(com.nurshabrina.noteme.R.menu.menu_form, menu);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.nurshabrina.noteme.R.id.action_delete:
