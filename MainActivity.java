...
import com.nurshabrina.noteme.adapter.NoteAdapter;
import com.nurshabrina.noteme.db.NoteHelper;
import com.dicoding.picodiploma.mynotesapp.entity.Note;
import java.lang.ref.WeakReference;
import java.util.ArrayList;

import static com.nurshabrina.noteme.NoteAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nurshabrina.noteme.R.layout.activity_main);

        if (getSupportActionBar() != null)
            getSupportActionBar().setTitle("Notes");

        rvNotes = findViewById(com.nurshabrina.noteme.R.id.rv_notes);
        ...
        progressBar = findViewById(com.nurshabrina.noteme.R.id.progressbar);
        fabAdd = findViewById(com.nurshabrina.noteme.R.id.fab_add);
    ...
    public void onClick(View view) {
        if (view.getId() == com.nurshabrina.noteme.R.id.fab_add) {
